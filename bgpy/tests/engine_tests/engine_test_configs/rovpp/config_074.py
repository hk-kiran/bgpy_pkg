...
from bgpy.tests.engine_tests.as_graph_infos import as_graph_info_039
...
config_074 = EngineTestConfig(
    ...
    desc=(
        ...
        "to 1.2.3/24\n via AS 1 to the legit origin, AS 5.\n"
        "Similarly, AS 3’s "
    ...
    scenario_config=ScenarioConfig(
        ...
        override_non_default_asn_cls_dict=frozendict({33: ROVPPV2SimpleAS}),
        AnnCls=ROVPPAnn,
    ),
    as_graph_info=as_graph_info_039,
)
