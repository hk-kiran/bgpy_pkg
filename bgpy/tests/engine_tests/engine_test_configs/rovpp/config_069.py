...
from bgpy.tests.engine_tests.as_graph_infos import as_graph_info_038
...
from bgpy.simulation_engine.policies.rovpp import ROVPPAnn, ROVPPV1LiteSimpleAS


config_069 = EngineTestConfig(
    name="069",
    desc=(
    ...
    as_graph_info=as_graph_info_038,
)
